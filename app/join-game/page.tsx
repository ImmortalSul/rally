...
function JoinGameContent() {
  ...
  const handlePaymentConfirm = () => {
    ...
    setTimeout(() => {
      ...
      // Show success animation and stay on success screen
      setTimeout(() => {
        // Payment completed successfully - user can manually navigate to picks
            ...
            {!paymentSuccess ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-400 text-sm">
                    Confirm your entry to this lobby
                  </p>
                </div>
                ...
                <div className="bg-slate-700/30 rounded-xl p-4 mb-6">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-slate-300">Legs Required</span>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-slate-400 text-sm mb-6">
                  You're now registered for this game. Time to make your picks!
                </p>
                <Link
                  href={`/picks?gameId=${gameInfo.id}&legs=${gameInfo.legs}&buyIn=${gameInfo.buyIn}`}
                  className="w-full bg-gradient-to-r from-[#00CED1] to-blue-500 text-white font-bold py-3 px-4 rounded-xl hover:from-[#00CED1]/90 hover:to-blue-500/90 transition-all duration-300 inline-block"
                >
                  Make Your Picks
                </Link>
              </div>
