...
function JoinGameContent() {
  ...
  const handleJoinGame = () => {
    ...
    window.location.href = `/picks?gameId=${gameInfo.id}&legs=${gameInfo.legs}&buyIn=${gameInfo.buyIn}&gameName=${encodeURIComponent(gameInfo.name)}`;
  };
          ...
          <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-md border border-[#00CED1]/30 rounded-2xl p-6 shadow-2xl shadow-[#00CED1]/10">
            ...
            >
              ...
              <span className="relative z-10">
                Make Your Picks • {spotsLeft} Spot{spotsLeft !== 1 ? "s" : ""}{" "}
                Left
              </span>
            </button>
