        ...
        <div className="py-24 md:py-32">
          ...
          <div className="mx-auto max-w-3xl pb-20 text-center md:pb-24">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Challenge friends with real-time predictions, track your
              performance, and compete in a social sports betting experience
              designed for transparency and fun.
            </p>
          </div>
          {/* Planet */}
              ...
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-400/30 before:to-violet-400/20 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.blue.400/0.3),transparent)]">
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    ...
                    />
                    <BettingTag
                      text="Lakers +5.5 • Live"
                      className="absolute left-56 top-7 z-10 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-60 transition-opacity duration-500"
                    />
                    <BettingTag
                      text="Arsenal Win • Lost"
                      className="absolute -left-20 bottom-24 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-40 transition-opacity duration-500"
                    />
                    <BettingTag
                      text="Yankees ML ✓ Won"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <article className="relative bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              ...
              <p className="text-gray-300 leading-relaxed">
                Challenge friends to live prediction battles and see results
                instantly. Build your head-to-head record across all major
                sports and leagues with transparent, real-time tracking.
              </p>
            </article>
            ...
            <article className="relative bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center">
                  <svg
                    className="fill-emerald-400 w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                  >
              ...
              <p className="text-gray-300 leading-relaxed">
                Climb the leaderboards and track your prediction accuracy across
                different sports. Compete for weekly recognition and build your
                reputation as a sports prediction expert.
              </p>
            </article>
            ...
            <article className="relative bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-violet-500/20 rounded-xl flex items-center justify-center">
                  <svg
                    className="fill-violet-400 w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                  >
                    <path
              ...
              <p className="text-gray-300 leading-relaxed">
                Get matched with opponents at your skill level using our
                intelligent pairing system. Enjoy fair, competitive matches that
                keep you engaged and improving.
              </p>
            </article>
            ...
            <article className="relative bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-orange-500/20 rounded-xl flex items-center justify-center">
                  <svg
                    className="fill-orange-400 w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                  >
              ...
              <p className="text-gray-300 leading-relaxed">
                Create exclusive prediction leagues with your closest friends.
                Set up group challenges and track everyone's performance within
                your private circle.
              </p>
            </article>
            ...
            <article className="relative bg-gray-800/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-pink-500/20 rounded-xl flex items-center justify-center">
                  <svg
                    className="fill-pink-400 w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                  >
              ...
              <p className="text-gray-300 leading-relaxed">
                Stay updated with instant notifications about your active
                predictions, friend challenges, and leaderboard changes. Never
            ...
            <article className="relative bg-slate-800/50 border border-slate-700 rounded-2xl p-8 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-xl flex items-center justify-center">
                  <svg
                    className="fill-cyan-400 w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                  >
              ...
              <p className="text-slate-300 leading-relaxed">
                Unlock exclusive badges and achievements as you improve your
                prediction skills. Earn recognition with special titles and
                showcase your sports knowledge.
              </p>
            </article>
          </div>
        </div>
